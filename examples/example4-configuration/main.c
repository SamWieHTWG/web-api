...
int main(int argc, char *argv[])
{
  ...
  */
  ...
  /* If the libxml2 is not known to the system, this function can be used
  to set the library path */
  // cnc_set_xml_parser_path(".");
  ...
  */
  ...
  /* Create menu thread */
  unsigned int menu_activition_bitmap =   MENU_UPDATE_CONFIG | MENU_RESET_KERNEL |
